...
test.describe('Menu', () => {
    ...
    test('should focus on first menu item when focus is called', async () => {
        ...
        await root.evaluate(node => {
            var _a;
            (_a = document.querySelector('fluent-menu-list')) === null || _a === void 0 ? void 0 : _a.focus();
        });
        expect(await menuItems.first().evaluate(node => {
    ...
    test('should not throw when focus is called with no items', async () => {
        ...
        expect(await page.evaluate(() => { var _a; return (_a = document.activeElement) === null || _a === void 0 ? void 0 : _a.id; })).toBe('');
    });
    ...
    test('should not navigate to hidden items when changed after connection', async () => {
        ...
        await ((_a = (await element.elementHandle())) === null || _a === void 0 ? void 0 : _a.waitForElementState('stable'));
        ...
        await ((_b = (await element.elementHandle())) === null || _b === void 0 ? void 0 : _b.waitForElementState('stable'));
        await element.press('ArrowDown');
        await expect(menuItems.nth(1)).toBeFocused();
        await element.press('ArrowDown');
    ...
    test('should navigate to submenu, close it with escape key, and return focus to the first menu item', async () => {
        ...
        await ((_a = (await element.first().elementHandle())) === null || _a === void 0 ? void 0 : _a.waitForElementState('stable'));
        await expect(menuItems.nth(1)).toBeFocused();
        await element.first().press('Escape');
        await ((_b = (await element.first().elementHandle())) === null || _b === void 0 ? void 0 : _b.waitForElementState('stable'));
        await expect(menuItems.first()).toBeFocused();
    });
...
//# sourceMappingURL=menu-list.spec.js.map